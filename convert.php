<?php
	...
	//$imax = 10000;
	//for ($i=0; $i < $imax; $i++){
	//	shifthue("img/".$_GET["img"].".png", $_GET["mode"], $_GET["r"], $_GET["g"], $_GET["b"]);
	//}	
	//$end_time = microtime(TRUE);
	//$time = ($end_time - $start_time)/$imax;
	//echo "$time sec <br>".phpversion();
	output("img/".$_GET["img"].".png", $_GET["mode"], $_GET["r"], $_GET["g"], $_GET["b"]);
?>
